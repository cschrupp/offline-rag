...
**Consequence:** Implementation proceeded 9A→9F (+ 9H-P detour). Slices **9A**–**9E** complete; **9F GO**; **9H-P COMPLETE / NON-PROMOTIONAL**. **9G** deferred (publication readiness); formal **9H** frozen. DeepEval/Ragas/Giskard/NotebookLM are not required architecture. Promotion of Arm H / query-prompt remains an explicit later decision (formal 9H after future 9G); provenance-v2 evidence is Milestone 5 / Slice 10. Canonical plan: `docs/milestone4_offline_gold_authoring.md`. Slice 10 design: `docs/slice10_generation_semantic_evaluation.md`.
