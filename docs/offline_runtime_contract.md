...
Full claim for later slices also includes: context expansion (7), generation/citation validation (8+), and expanded evaluation — once those stages exist. Hybrid/RRF (5) and hybrid-rerank (6) are implemented.
