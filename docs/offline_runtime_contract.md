...
Context expansion (7), grounded generation/citation membership validation (8), and retrieval-eval harness (9) are implemented ([`slice9_retrieval_evaluation.md`](slice9_retrieval_evaluation.md)). Milestone 4 offline gold authoring: **9A**–**9E** done; **9F GO**; **9H-P COMPLETE / NON-PROMOTIONAL**; **9G** deferred; formal **9H** frozen — [`milestone4_offline_gold_authoring.md`](milestone4_offline_gold_authoring.md). Milestone 5 / Slice 10 generation & citation semantic evaluation: design drafted / not started — [`slice10_generation_semantic_evaluation.md`](slice10_generation_semantic_evaluation.md).
