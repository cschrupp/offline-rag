...
- BM25 → Slice 4 (done); hybrid/RRF → Slice 5 (done); rerank → Slice 6 (done)
- parent/neighbor expansion at query time → Slice 7 (done)
- generation → Slice 8 (done — see `docs/slice8_grounded_generation.md`)
