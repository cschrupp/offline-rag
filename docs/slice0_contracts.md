...
Still deferred: Milestone 4 remaining slices **9F**–**9H** (**9A**–**9E** done including `gold propose` / `gold pool` / `gold prelabel` / `gold review` / `gold finalize`), and Milestone 5 / Slice 10 semantic answer/citation quality metrics.
