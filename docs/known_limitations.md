...
- No production `ics_modules` retrieval gold set yet; only the small Slice 9 harness fixture exists. Milestone 4 (9A–9E done; 9F–9H remaining) is the private gold-authoring path.
