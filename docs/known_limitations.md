...
- No production `ics_modules` retrieval gold set yet; only the small Slice 9 harness fixture exists. Milestone 4 (9A–9B done; 9C–9H remaining) is the private gold-authoring path.
