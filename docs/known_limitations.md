...
- No production `ics_modules` retrieval gold set yet; only the small Slice 9 harness fixture exists. Milestone 4 (Slices 9A–9H) is the planned private gold-authoring path.
