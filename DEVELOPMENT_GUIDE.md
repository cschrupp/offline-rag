...
# Milestone 4 (9A–9E done; 9F IN PROGRESS — execution pending):
...
Milestone 4 offline gold authoring (Slice **9F** **IN PROGRESS** — runbook ready; execution pending) builds private-corpus gold locally; see `docs/slice9f_pilot_runbook.md`, `docs/slice9e_human_review.md`, `docs/slice9d_relevance_prelabel.md`, `docs/slice9c_candidate_pooling.md`, `docs/slice9b_gold_propose.md`, `docs/slice9a_gold_authoring.md`, and `docs/milestone4_offline_gold_authoring.md`. Do not treat silver/authoring drafts as gold.
