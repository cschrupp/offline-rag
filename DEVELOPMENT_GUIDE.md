...
# Milestone 4 (9A–9D done; review/finalize later):
...
Milestone 4 offline gold authoring (next: Slice **9E**) builds private-corpus gold locally; see `docs/slice9d_relevance_prelabel.md`, `docs/slice9c_candidate_pooling.md`, `docs/slice9b_gold_propose.md`, `docs/slice9a_gold_authoring.md`, and `docs/milestone4_offline_gold_authoring.md`. Do not treat silver/authoring drafts as gold.
