...
TITLE_SECTION_TEXT_V1 = "title-section-text-v1"
DOCUMENT_TITLE_V1 = "document-title-v1"
RAW_QUERY_V1 = "raw-query-v1"
MODEL_QUERY_PROMPT_V1 = "model-query-prompt-v1"
ALL_CHILDREN_V1 = "all-children-v1"
EXCLUDE_HEADING_ONLY_V1 = "exclude-heading-only-v1"
...
# Lexical metadata-aware ranking text reuses TITLE_SECTION_TEXT_V1 / DOCUMENT_TITLE_V1.
