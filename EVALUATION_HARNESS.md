...
**Next (Milestone 4):** Offline gold authoring (Slices 9A–9H) builds human-adjudicated private-corpus gold via a local LLM assistant + review workflow, then uses this harness for retrieval A/B and promotion decisions. Canonical plan: [`docs/milestone4_offline_gold_authoring.md`](docs/milestone4_offline_gold_authoring.md). Slices **9A**/**9B**/**9C** done ([`docs/slice9a_gold_authoring.md`](docs/slice9a_gold_authoring.md), [`docs/slice9b_gold_propose.md`](docs/slice9b_gold_propose.md), [`docs/slice9c_candidate_pooling.md`](docs/slice9c_candidate_pooling.md)); next decision track: **Slice 9D**. Silver/authoring drafts must never be accepted as gold by `eval retrieve`.
